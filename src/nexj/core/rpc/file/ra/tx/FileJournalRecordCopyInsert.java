 ...
 * file to a destination file, creating that destination file in the process.
 */
public final class FileJournalRecordCopyInsert extends GenericJournalRecord
{
   // constants
    ...
    */
   private static final long serialVersionUID = 2247592485617216561L;

   /**
    * Operation: Copy temporary file to persistence directory (for INSERT) or
    * to outgoing message directory (for outgoing message connection).
    */
   public final static int OPCODE = 15;
   ...
   /**
    * Creates a new COPY_INSERT record.
    * 
    ...
    */
   public FileJournalRecordCopyInsert(Xid xid, String sSrcPath, String sDestPath, LockableFile sourceHandle, LockableFile destHandle)
   {
      setXid(xid);
   ...
   /**
    * @return The path to the file containing data to be copied.
    */
   ...
   {
      return FileJournalRecordCopyInsert.OPCODE;
   }
