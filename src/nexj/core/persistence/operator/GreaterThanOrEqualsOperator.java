...
public final class GreaterThanOrEqualsOperator extends ComparisonOperator
{
    ...
    */
   public final static int ORDINAL = 13;
    ...
    * The operator symbol.
    */
   public final static Symbol SYMBOL = Symbol.GE;
   ...
   {
      return (bRHS) ? BOOL_LHS : BOOL_TRUE;
   }
   ...
   {
      return Primitive.ge(left, right);
   }
   ...
   {
      return ((Primitive)m_left.getType()).getGEFunction((Primitive)m_right.getType()).invoke(m_left.getValue(), m_right.getValue());
   }
