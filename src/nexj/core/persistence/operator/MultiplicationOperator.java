...
public final class MultiplicationOperator extends BinaryOperator
{
    ...
    */
   public final static int ORDINAL = 6;
    ...
    * The operator symbol.
    */
   public final static Symbol SYMBOL = Symbol.MUL;
   ...
   {
      return ((Primitive)m_left.getType()).getMultiplicationFunction((Primitive)m_right.getType()).invoke(m_left.getValue(), m_right.getValue());
   }
}
