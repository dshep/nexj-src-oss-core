...
public final class GreaterThanOperator extends ComparisonOperator
{
    ...
    */
   public final static int ORDINAL = 12;
    ...
    * The operator symbol.
    */
   public final static Symbol SYMBOL = Symbol.GT;
   ...
   {
      return (bRHS) ? BOOL_FALSE : BOOL_LHS;
   }
   ...
   {
      return Primitive.gt(left, right);
   }
   ...
   {
      return ((Primitive)m_left.getType()).getGTFunction((Primitive)m_right.getType()).invoke(m_left.getValue(), m_right.getValue());
   }
   ...
   {
      return value.setScale(0, BigDecimal.ROUND_FLOOR).longValue();
   }
