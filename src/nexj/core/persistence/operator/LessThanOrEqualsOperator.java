...
public final class LessThanOrEqualsOperator extends ComparisonOperator
{
    ...
    */
   public final static int ORDINAL = 15;
    ...
    * The operator symbol.
    */
   public final static Symbol SYMBOL = Symbol.LE;
   ...
   {
      return (bRHS) ? BOOL_TRUE : BOOL_NOT;
   }
   ...
   {
      return Primitive.le(left, right);
   }
   ...
   {
      return ((Primitive)m_left.getType()).getLEFunction((Primitive)m_right.getType()).invoke(m_left.getValue(), m_right.getValue());
   }
