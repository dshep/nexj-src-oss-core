...
/**
 * 2D hash table using soft references to store the values.
 */
public class SoftHashTab2D extends HashTab2D
{
   // constants
    ...
    */
   private final static long serialVersionUID = -234267033520674311L;
    ...
    */
   public SoftHashTab2D(int nCount)
   {
      super(nCount);
   }
   ...
   public Iterator valueIterator()
   {
      ...
      return new SoftHashTab2DValueIterator();
   }
   ...
   public Object clone()
   {
      ...
      SoftHashTab2D htab = (SoftHashTab2D)super.clone();
      Ref ref;
   ...
   protected class SoftHashTab2DValueIterator extends GenericHashTab2DValueIterator
   {
      /**
      ...
      public void setValue(Object value)
      {
         ...
         if (m_table != SoftHashTab2D.this.m_table)
         {
