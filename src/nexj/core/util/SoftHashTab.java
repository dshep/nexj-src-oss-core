...
/**
 * Hash table using soft references to store the values.
 */
public class SoftHashTab extends HashTab
{
   // constants
    ...
    */
   private final static long serialVersionUID = 8511571348546691304L;
   ...
   public Object clone()
   {
      ...
      SoftHashTab htab = (SoftHashTab)super.clone();
      Ref ref;
   ...
   public Iterator iterator()
   {
      ...
      return new SoftHashTabIterator();
   }
   ...
   public Iterator valueIterator()
   {
      ...
      return new SoftHashTabValueIterator();
   }
   ...
   protected class SoftHashTabIterator extends GenericHashTabIterator
   {
      /**
      ...
      public void setValue(Object value)
      {
         ...
         if (m_table != SoftHashTab.this.m_table)
         {
   ...
   protected class SoftHashTabValueIterator extends SoftHashTabIterator
   {
      /**
