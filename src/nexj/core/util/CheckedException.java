...
/**
 * Base class for all localizeable checked exceptions.
 ...
 * e.g. "err.meta.lookup"
 */
public class CheckedException extends Exception implements ErrorCode, PropertyMap
{
   // constants
    ...
    */
   private final static long serialVersionUID = 3570082672891743250L;
   ...
   /**
    * Create a checked exception with an error code.
    * @param sErrCode The error code/string id of the error message.
    */
   public CheckedException(String sErrCode)
   {
      super((String)null);
      m_sErrCode = sErrCode;
      m_argArray = null;
   ...
   /**
    * Create a checked exception with an error code and a message argument array.
    * @param sErrCode The error code/string id of the error message.
    * @param argArray The message argument array.
    */
   public CheckedException(String sErrCode, Object[] argArray)
   {
      super((String)null);
      m_sErrCode = sErrCode;
      m_argArray = argArray;
   ...
   /**
    * Create a checked exception with an error code and a nested exception.
    * @param sErrCode The error code/string id of the error message.
    * @param cause The nested exception that has caused this exception.
    */
   public CheckedException(String sErrCode, Throwable cause)
   {
      super(null, cause);
      m_sErrCode = sErrCode;
      m_argArray = null;
   ...
   /**
    * Create a checked exception with an error code, message argument array
    * and a nested exception.
    * @param sErrCode The error code/string id of the error message.
    * @param argArray The message argument array.
    * @param cause The nested exception that has caused this exception.
    */
   public CheckedException(String sErrCode, Object[] argArray, Throwable cause)
   {
      super(null, cause);
      m_sErrCode = sErrCode;
      m_argArray = argArray;
